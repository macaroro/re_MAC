...
<div class="container-fluid position-relative p-0">
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Intoduce</h1>
    ...
    <!-- Navbar End -->
                ...
                <div class=" text-center text-black">
            		...
            		<h1>저희는요!!</h1>
            		     &nbsp;&nbsp;&nbsp;&nbsp;
            		<h4>창업을 준비중인 예비 사장님들, 이미 창업을 하신 사장님분들에게 </h4>
            		<h4>서울시의 상권분석 데이터를 한눈에 보기 쉽게 보여주고 창업 관련 커뮤니티와 
            		사장님들의 가게를 홍보할 수 있습니다!</h4>
            ...
            <div class="row g-5">
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                        ...
                        <h4 class="mb-3">같이 이야기를 나눠요</h4>
                        <p class="m-0">창업관련 정보를 나눌수 있고 자신의 가게까지 광고할 수 있습니다 </p>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                        ...
                        <h4 class="mb-3">상권을 한눈에!</h4>
                        <p class="m-0">서울시 상권의 매출, 인구, 점포의 데이터를 서울시의 지도와 함께 보여줍니다</p>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.9s">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                        ...
                        <h4 class="mb-3">데이터를 한눈에!</h4>
                        <p class="m-0">서울시 상권의 매출, 인구, 점포의 데이터를 그래프로 보여줌니다</p>
                        <a class="btn btn-lg btn-primary rounded" href="">
                            <i class="bi bi-arrow-right"></i>
                        </a>
                    </div>
