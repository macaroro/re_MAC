...
<div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
	<div class="row py-5">
		...
		<br><br><br><br><br><br>
			<h1 class="display-4 text-blue animated zoomIn"></h1>
		</div>
	</div>
</div>
<!-- Navbar End -->
...
<div class="allchart">
	...
	<div class="population">
		<div class="bg-light text-center rounded p-4">
			<div class="d-flex align-items-center justify-content-between mb-4">
				<h6 class="mb-0">서울시 골목상권 유동인구(억)</h6>
			</div>
	...
	<div class="store">
		<div class="bg-light text-center rounded p-4">
			<div class="d-flex align-items-center justify-content-between mb-4">
				<h6 class="mb-0">서울시 골목상권 개업, 패업 점포수</h6>
			</div>
...
<!-- Service Start -->
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s" id="homeservice">
		...
		<div class="row g-5">
			<div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
				<div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
					...
					<h4 class="mb-3">창업 커뮤니티</h4>
					<p class="m-0">
						창업 관련 정보를 얻고 자신의 가게를 홍보할수 있습니다
					</p>
					<a class="btn btn-lg btn-primary rounded" href="/board/main">
			...
			<div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
				<div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
					...
					<h4 class="mb-3">그래프로 빅데이터 시각화</h4>
					<p class="m-0">
						매출,인구,점포를 보기쉽게 그래프로 보여줌
					</p>
					<a class="btn btn-lg btn-primary rounded" href="/big/location">
					<i class="bi bi-arrow-right"></i>
					</a>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.9s">
				<div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
					...
					<h4 class="mb-3">빅데이터 분석</h4>
					<p class="m-0">
						매출,인구,점포 데이터를 활용한 빅데이터 분석 
					</p>
...
<script src="/main/js/homeMain.js"></script>
</body>
</html>